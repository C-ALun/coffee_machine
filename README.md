...
<div align="center">
  ...
  <p align="center">
    ...
    <br />
    <a href="https://github.com/C-ALun/coffee_machine/blob/main/main.py">View My_demo</a>
  </p>
</div>
...
* I had made a dupliated mistakes by checking ingredients from data.py by using if statements. While there isn't all hot drinks using all ingredients. I found out I can use for loop to avoid it.

* Get used to design functions, let my codes more maintainable.
